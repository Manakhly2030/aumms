...
fixtures = [
    ...
    {
		"dt":"Workflow",
		"filters":[["name","in",["Purchase Receipt Workflow"]]]
	},
    {
		"dt":"Workflow Action Master",
		"filters":[["name","in",["Submit", "Send for Hallmarking", "Hallmark Items Return"]]]
	},
    {
		"dt":"Workflow State",
		"filters":[["name","in",["Draft", "Submitted", "Sent for Hallmarking", "Send for Hallmarking", "Items Hallmarked"]]]
	},
	]
